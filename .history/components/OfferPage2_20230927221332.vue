  ...
  <div class="relative min-h-screen w-screen pb-10">
    <div class="lg:max-w-lg m-auto">
      ...
      >
        ...
        >
          <FireIcon
            class="hidden ml-3 md:ml-0 md:block absolute -top-14 right-19px rounded-xl md:rounded-3xl blur-sm"
          />
          <div class="absolute left-0 right-0 bottom-0 top-0 bg-black/40"></div>
