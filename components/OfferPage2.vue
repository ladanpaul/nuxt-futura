<template>
  <div class="relative min-h-screen w-screen pb-10">
    <div class="lg:max-w-lg m-auto">
      ...
      >
        <section
          class="mt-6 md:mb-10 md:mt-20 md:w-[473px] bg-black/60 p-4 md:p-0 md:bg-transparent rounded-3xl md:rounded-none"
        >
          <h3
            class="text-32px md:text-40px font-extrabold leading-38px md:leading-57px md:uppercase"
          >
            <span class="text-cornflowerBlue">Start</span> your
            <br class="hidden md:block" />
            learning<br class="md:hidden" />
            journey <br class="hidden md:block" />
            <span class="text-cornflowerBlue">now</span>
          </h3>
          <p class="mt-4 md:mt-6 text-2xl font-semibold leading-7">
            Get a
        ...
        >
          ...
          >
            ...
            <p class="hidden md:block mt-6 text-center text-xs text-periwinkle">
              $0.99 charged today. If you don't cancel at least 24 hours before
    ...
    <UiPopup ref="popup" theme="dark">
      <div class="p-4 pt-6 w-[336px] md:w-[400px] text-white">
