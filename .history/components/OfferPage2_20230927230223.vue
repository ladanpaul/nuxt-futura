  ...
  <div class="relative min-h-screen w-screen pb-10">
    <div class="lg:max-w-lg m-auto">
      ...
      >
        ...
        <section
          class="relative md:ml-6 mt-65px md:w-[474px] bg-transparent border-4 border-white/40 rounded-xl md:rounded-[33px]"
        >
          <FireIcon
            class="hidden ml-3 md:ml-0 md:block absolute -top-14 right-19px"
          />
          <div
            class="bg-black/40 backdrop-blur-sm py-3 px-4 md:p-6 rounded-xl md:rounded-[30px]"
          >
