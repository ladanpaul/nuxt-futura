<template>
  <div class="relative">
    ...
    <div
      v-if="isOpen"
      :class="[
        'absolute top-full flex flex-col max-h-[200px] w-full z-1 bg-white overflow-auto rounded-bl-lg rounded-br-lg border border-linkWater border-t-0 text-raven',
        {
