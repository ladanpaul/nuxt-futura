    ...
    <div class="lg:max-w-lg m-auto">
      ...
      <main class="flex w-fit mx-auto">
        <section class="mt-20 md:w-[473px]">
          ...
          <UiButton theme="black" class="mt-8 w-[273px]">Get my plan</UiButton>
        </section>
        <section
          class="payment-card relative ml-6 mt-65px md:w-[474px] p-6 pt-9 bg-white border borderlightGrey100 rounded-3xl"
        >
          <FireIcon class="absolute right-0 -top-14 right-5" />
          ...
          <div class="mt-9">
            ...
            <UiButton
              class="mt-6 border border-black border-opacity-20 w-full font-semibold text-neon"
            >
...
<script>
import { LogoDefaultIcon, StarIcon, LockIcon, FireIcon } from "@/icons";
