        ...
        >
          ...
          <div class="flex items-center justify-between">
            <div>
              ...
              <p v-if="isExpiredTimer" class="mt-2 w-fit font-semibold text-xl relative leading-6">
                Then $39.99/Then $9.99/week</span>
              </p>
              <template v-else>
            ...
            <UiTimer v-if="!isExpiredTimer" @expired="isExpiredTimer = true" />
          </div>
          <div class="mt-9">
            <div
