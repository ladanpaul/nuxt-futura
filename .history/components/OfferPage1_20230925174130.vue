    ...
    <div class="lg:max-w-lg m-auto">
      ...
      <main class="flex w-fit mx-auto">
        ...
        >
          ...
          <div style="border: 1px solid blue; opacity: 0.3">
            <p
              class="mt-2 w-fit font-semibold text-xl text relative text-nobel"
            >
              Then $39.99/week
            </p>
          </div>
...
.text {
  position: relative;
  color: #000; /* Змінено колір тексту на темно-сірий */
}
...
.text::after {
  ...
  background: #fff; /* Змінено колір фону на чорний */
}
</style>
