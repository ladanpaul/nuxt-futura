  ...
  <div class="relative text-raven">
    ...
    >
      <div
        ...
        :key="idx"
        class="flex items-center w-full px-4 min-h-32px text-xs cursor-pointer border border-b-0 border-linkWater last:border-b last:rounded-bl-lg last:rounded-br-lg"
        @click="select(item)"
      >
        <span>{{ item }}</span>
