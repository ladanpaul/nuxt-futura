  ...
  <div class="relative min-h-screen w-screen">
    ...
    <UiPopup ref="popup">
      <div class="w-[368px]">
        ...
        <UiButton class="mt-6 w-full" theme="payment">
          <PayPalIcon />
          <span class="uppercase ml-2.5">buy now</span>
        </UiButton>
        <UiButton class="mt-6 border border-black border-opacity-20 w-full">
          <GooglePay class="w-6 h-6" />
          <span class="uppercase ml-2.5 font-bold">pay</span>
        </UiButton>
      </div>
    </UiPopup>
  </div>
