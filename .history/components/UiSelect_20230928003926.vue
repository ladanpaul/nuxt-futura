<template>
  <div class="relative">
    ...
    <div
      v-if="isOpen"
      :class="[
        'absolute top-full flex flex-col max-h-[200px] w-full z-1  overflow-auto rounded-bl-lg rounded-br-lg border  border-t-0 ',
        {
          'bg-white border-linkWater text-raven': theme === 'white',
          'bg-waikawaGrey border-white/10 text-white': theme === 'dark',
        },
      ]"
    >
      <div
        ...
        :class="[
          ...
          {
            'bg-waikawaGrey border-white/10 text-white': theme === 'dark',
            '!bg-cornflowerBlue': selectedValue === item && theme === 'dark',
            'bg-waikawaGrey border-white/10 text-white': theme === 'white',
