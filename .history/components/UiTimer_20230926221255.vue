<template>
  <div class="flex flex-col w-[160px] bg-black rounded-xl">
    <div
      class="flex items-center h-[60px] bg-pastelGreen transition-width duration-1000 ease-linear rounded-xl"
