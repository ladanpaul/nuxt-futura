<template>
  <div class="relative min-h-screen w-screen pb-10">
    <div class="lg:max-w-lg m-auto">
      ...
      >
        <section class="mb-10 mt-20 md:w-[473px]">
        ...
        <section
          class="payment-card relative ml-6 mt-65px md:w-[474px] py-3 mx-4 md:p-6 bg-white border borderlightGrey100 rounded-xl md:rounded-3xl"
        >
          <FireIcon class="hidden md:block absolute -top-14 right-19px" />
          <div class="flex justify-between">
            <div>
              <h3 class="md:text-2xl font-bold md:text-2xl md:leading-7">
                3-day trial for
                <span class="text-neon font-extrabold">$0.99</span>
              </h3>
              <p
                v-if="isExpiredTimer"
                class="mt-2 w-fit font-semibold text-xl relative leading-6"
              >
                Then $39.99/week
              </p>
              <template v-else>
