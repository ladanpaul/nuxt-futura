  ...
  <div
    :class="[
      'flex relative py-1 pl-4 pr-3 h-[46px] border rounded-lg',
      {
        ...
        'border-cornflowerBlue': theme === 'dark',
      },
    ]"
  >
    <span
      v-if="label"
      :class="[
        'absolute bg-white px-1.5 left-3 -top-2 text-xs font-bold',
    ...
    <input
      ...
      :value="value"
      class="w-full border border-transparent outline-none text-raven text-xs"
      :pattern="pattern"
