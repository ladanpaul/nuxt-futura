<template>
  <div class="relative min-h-screen w-screen">
    <div class="lg:max-w-lg m-auto">
      ...
      <main class="flex w-fit mx-auto px-5">
        <section class="mt-20 md:max-w-[473px]">
        ...
        <section
          class="payment-card relative ml-6 mt-65px md:max-w-[474px] p-6 bg-white border borderlightGrey100 rounded-3xl"
        >
