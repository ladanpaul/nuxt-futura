<template>
  <div class="relative min-h-screen w-screen">
    <div class="lg:max-w-lg m-auto">
      ...
      <main
        class="flex mx-auto md:flex-wrap lg:flex-nowrap justify-center items-center"
      >
        <section class="md:mt-14 lg:mt-20 lg:w-[473px]">
        ...
        <section
          class="payment-card relative ml-6 mt-65px lg:w-[474px] p-6 bg-white border borderlightGrey100 rounded-3xl"
        >
