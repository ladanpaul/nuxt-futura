    ...
    >
      <div
        ...
        :class="[
          ...
          {
            'text-white bg-pastelGreen': selectedValue === item && theme ==='white'
            'text-white bg-cornflowerBlue': selectedValue === item && theme ==='white'
            'bg-waikawaGrey': theme === 'white',
            'bg-cornflowerBlue': theme === 'dark',
          },
        ]"
        @click="select(item)"
      >
