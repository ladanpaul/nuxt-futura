<template>
  ...
  >
    <div
      :class="['absolute -left-px right-0 top-0 bottom-0 flex items-center h-[60px] transition-width duration-1000 ease-linear rounded-xl', {'bg-pastelGreen': theme === 'green', ''}]"
