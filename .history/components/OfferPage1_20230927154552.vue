      ...
      <main class="flex w-fit mx-auto">
        ...
        >
          ...
          <div class="flex justify-between">
            ...
            <UiTimer class="mt-2.5" @expired="isExpiredTimer = true" />
          </div>
          <div class="mt-9">
            <div
...
export default {
  ...
  beforeMount() {
    ...
    const time = this.$cookies.get("planet_timer");
    console.log("cookiesTime -> ", time);
    // console.log("isExpiredTimer -> ", this.isExpiredTimer);
