    ...
    <UiPopup ref="popup">
      <div class="w-[368px]">
        ...
        <div class="flex items-center justify-between flex-nowrap mt-8">
          <UiSelect :items="months" label="Months" class="w-[116px]" />
          <UiSelect :items="years" label="Year" class="w-[116px]" />
          <UiInput
            isCvv
            placeholder="•••"
            label="CVC"
        ...
        <div class="flex flex-col items-center justify-center mt-10 w-[300px]">
          <UiButton theme="black" :disabled="!isValid">Submit</UiButton>
