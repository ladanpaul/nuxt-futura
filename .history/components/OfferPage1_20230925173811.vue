    ...
    <div class="lg:max-w-lg m-auto">
      ...
      <main class="flex w-fit mx-auto">
        ...
        >
          ...
          <p class="mt-2 w-fit font-semibold text-xl text relative text-nobel">
            Then $39.99/week
          </p>
        </section>
      </main>
...
.text {
  position: relative;
  color: #999999; /* Змінено колір тексту на темно-сірий */
}
...
.text::after {
  ...
  background-color: rgba(#fff); /* Змінено колір фону на чорний */
}
</style>
