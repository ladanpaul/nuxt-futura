  ...
  <div class="relative min-h-screen w-screen">
    ...
    <UiPopup ref="popup">
      <div class="w-[368px]">
        ...
        <div
          class="flex mt-8 relative h-[46px] border border-linkWater rounded-lg"
        >
          <span class="absolute bg-white p-1 left-6 -top-6 text-xs font-bold"
            >Card number</span
          >
          <UiInput
            isCardNumber
