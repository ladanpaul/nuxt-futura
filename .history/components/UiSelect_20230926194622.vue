  ...
  <div class="relative">
    <div
      :class="[
        ...
        {
          'rounded-none rounded-tl-lg rounded-tr-lg border-pastelGreen': isOpen,
        },
      ]"
      @click="toggleSelect"
    >
      <span
        ...
        >{{ label }}</span
      >
      <div class="cursor-pointer text-xs text-raven">
    ...
    <div
      v-if="isOpen"
      class="absolute top-full flex flex-col h-[200px] w-full z-1 bg-white overflow-auto rounded-bl-lg rounded-br-lg border border-linkWater border-t-0 text-raven"
    >
      <div
