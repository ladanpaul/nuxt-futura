<template>
  <div class="relative flex flex-col rounded-xl h-[60px] overflow-hidden">
    <div
      class="absolute -left-[2px] right-0 top-0 bottom-0 flex items-center h-[60px] bg-black w-[160px] transition-width duration-1000 ease-linear rounded-xl"
    ></div>
    <div
      class="absolute -left-[2px] right-0 top-0 bottom-0 flex items-center h-[60px] bg-pastelGreen transition-width duration-1000 ease-linear rounded-xl"
