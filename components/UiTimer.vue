<template>
  <div
    :class="[
      'relative flex flex-col w-[110px] md:w-[160px] bg-black rounded-xl h-[47px] md:h-[60px] overflow-hidden',
      {
  ...
  >
    <div
      :class="[
        'absolute -left-px right-0 top-0 bottom-0 flex items-center h-[60px] transition-width duration-1000 ease-linear rounded-xl',
        {
          'bg-pastelGreen': theme === 'green',
          'bg-cornflowerBlue': theme === 'blue',
        },
      ]"
...
export default {
  ...
  beforeMount() {
    const savedTime = this.$cookies.get("planet_timer");
